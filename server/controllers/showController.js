...
export const getShows = async (req, res) => {
  try {
    //showDateTime >= currentDateAndTime (to get upcoming show not previous show)
...
export const getShow = async (req, res) => {
  try {
    ...
    //Extracts the date part (e.g., 2025-07-01).
    //Groups all the shows that happen on the same day together
    shows.forEach((show) => {
